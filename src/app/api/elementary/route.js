import { fetchElementaryWordData } from "../../services/elementaryService";
...
export async function GET(req) {
  ...
  try {
    ...
    const rawWordData = await fetchElementaryWordData(word);
    ...
    console.error("Error in Elementary API route:", error);
    return new Response(
